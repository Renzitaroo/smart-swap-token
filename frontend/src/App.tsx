...
export default function App() {
  ...
  return (
    <div className="page">
      <img className="hero-title" src={CONFIG.TITLE_IMG} alt="RENZIE TRADE" />

      <header className="head">
        <div className="brand">
          <img className="brand-logo" src={CONFIG.BRAND_LOGO} alt="RENZIE TRADE" />
          <div>
            <p className="eyebrow">SEPOLIA AMM DEX</p>
            <h1 className="brand-title">RENZIE <span className="highlight-trade">TRADE</span></h1>
          </div>
        </div>
        <div className="head-actions">
          <button className="theme-toggle" onClick={() => setTheme(t => t === "dark" ? "light" : "dark")} title="Ganti tema">
            {theme === "dark" ? "☾" : "☀"}
          </button>
      ...
      <div className="cols">
        ...
        <div className="col col-main">
          <Glass className="pill tabs" inner="tabs-row">
            ...
            <button className={`tab ${tab === "oracle" ? "tab--active" : ""}`} onClick={() => setTab("oracle")}>Oracle</button>
          </Glass>
